...
public final class ListView extends AndroidViewComponent implements OnItemClickListener {
    ...
    class C00571 implements TextWatcher {
        C00571() {
        }
    ...
    public ListView(ComponentContainer container) {
        ...
        this.txtSearchBox.addTextChangedListener(new C00571());
        if (this.showFilter) {
    ...
    public Spannable[] itemsToColoredText() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            chars.setSpan(new AbsoluteSizeSpan(this.textSize), 0, chars.length(), 0);
            objects[i - 1] = chars;
        }
        return objects;
    }
