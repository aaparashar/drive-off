...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C03062 implements AsyncCallbackPair<JSONObject> {
    ...
    class C03074 implements AsyncCallbackPair<String> {
    ...
    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C03062());
    }
    ...
    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C03074();
