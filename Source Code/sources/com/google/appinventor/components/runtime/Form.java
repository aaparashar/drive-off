...
public class Form extends Activity implements Component, ComponentContainer, HandlesEventDispatching, OnGlobalLayoutListener {
    ...
    class C00398 implements OnMenuItemClickListener {
        C00398() {
        }
    ...
    class C00409 implements OnMenuItemClickListener {
        C00409() {
        }
            ...
            this.androidUIHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (dispatchEventNow) {
                        ...
                        Form.this.androidUIHandler.postDelayed(new C00311(), 100);
    ...
    public void Initialize() {
        this.androidUIHandler.post(new C00332());
    }
    ...
    private void recomputeLayout() {
        ...
        this.androidUIHandler.post(new C00365());
    }
    ...
    public void addExitButtonToMenu(Menu menu) {
        menu.add(0, 0, 1, "Stop this application").setOnMenuItemClickListener(new C00398()).setIcon(17301594);
    }

    public void addAboutInfoToMenu(Menu menu) {
        menu.add(0, 0, 2, "About this application").setOnMenuItemClickListener(new C00409()).setIcon(17301651);
    }
