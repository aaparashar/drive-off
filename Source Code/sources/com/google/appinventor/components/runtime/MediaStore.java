...
public final class MediaStore extends AndroidNonvisibleComponent implements Component {
    ...
    class C03021 implements AsyncCallbackPair<String> {
        C03021() {
        }
    ...
    public void PostMedia(String mediafile) throws FileNotFoundException {
        AsyncCallbackPair<String> myCallback = new C03021();
        try {
            String newMediaPath;
    ...
    private String getUploadUrl() {
        try {
            ...
            con.setRequestProperty(HttpHeaders.USER_AGENT, "AppInventor");
            con.setRequestProperty(HttpHeaders.CONTENT_TYPE, "text/plain; charset=utf-8");
