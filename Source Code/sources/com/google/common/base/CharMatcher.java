...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final CharMatcher BREAKING_WHITESPACE = new C05381();
    ...
    public static final CharMatcher WHITESPACE = new FastMatcher("CharMatcher.WHITESPACE") {
        public boolean matches(char c) {
            return CharMatcher.WHITESPACE_TABLE.charAt(c % 79) == c;
        }
    };
    ...
    static class C05381 extends CharMatcher {
        C05381() {
        }
    ...
    public static CharMatcher isNot(final char match) {
        return new FastMatcher("CharMatcher.isNot(" + Integer.toHexString(match) + ")") {
            public boolean matches(char c) {
                return c != match;
            }
    ...
    CharMatcher precomputedInternal() {
        ...
        table.flip(0, 65536);
        return new NegatedFastMatcher(toString(), precomputedPositive(65536 - totalCharacters, table, this.description + ".negate()"));
    }
