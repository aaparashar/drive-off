...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        private static final long serialVersionUID = 0;
        /* renamed from: f */
        private final Function<A, ? extends B> f7f;
        /* renamed from: g */
        private final Function<B, C> f8g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f8g = (Function) Preconditions.checkNotNull(g);
            this.f7f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@Nullable A a) {
            return this.f8g.apply(this.f7f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f7f.equals(that.f7f) && this.f8g.equals(that.f8g)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f7f.hashCode() ^ this.f8g.hashCode();
        }

        public String toString() {
            return this.f8g.toString() + "(" + this.f7f.toString() + ")";
        }
    }
