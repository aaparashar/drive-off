...
public final class Predicates {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        private static final long serialVersionUID = 0;
        /* renamed from: f */
        final Function<A, ? extends B> f9f;
        /* renamed from: p */
        final Predicate<B> f10p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f10p = (Predicate) Preconditions.checkNotNull(p);
            this.f9f = (Function) Preconditions.checkNotNull(f);
        }

        public boolean apply(@Nullable A a) {
            return this.f10p.apply(this.f9f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f9f.equals(that.f9f) && this.f10p.equals(that.f10p)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f9f.hashCode() ^ this.f10p.hashCode();
        }

        public String toString() {
            return this.f10p.toString() + "(" + this.f9f.toString() + ")";
        }
    }
