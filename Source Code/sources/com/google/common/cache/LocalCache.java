...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final Queue<? extends Object> DISCARDING_QUEUE = new C01702();
    static final int DRAIN_MAX = 16;
    static final int DRAIN_THRESHOLD = 63;
    static final int MAXIMUM_CAPACITY = 1073741824;
    static final int MAX_SEGMENTS = 65536;
    static final ValueReference<Object, Object> UNSET = new C03261();
    ...
    static class C01702 extends AbstractQueue<Object> {
        C01702() {
        }
    ...
    static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C05521();

        /* renamed from: com.google.common.cache.LocalCache$AccessQueue$1 */
        class C05521 extends AbstractReferenceEntry<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        ListenableFuture<V> loadAsync(K key, int hash, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            loadingFuture.addListener(new Runnable() {
                public void run() {
                    try {
                        loadingValueReference2.set(Segment.this.getAndRecordStats(k, i, loadingValueReference2, loadingFuture));
                    } catch (Throwable t) {
    ...
    static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C05541();

        /* renamed from: com.google.common.cache.LocalCache$WriteQueue$1 */
        class C05541 extends AbstractReferenceEntry<K, V> {
    ...
    static class C03261 implements ValueReference<Object, Object> {
        C03261() {
        }
