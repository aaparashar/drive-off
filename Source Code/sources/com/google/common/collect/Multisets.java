...
public final class Multisets {
    private static final Ordering<Entry<?>> DECREASING_COUNT_ORDERING = new C04385();
    ...
    static class C04385 extends Ordering<Entry<?>> {
        C04385() {
        }
    ...
    private static final class FilteredMultiset<E> extends AbstractMultiset<E> {
        ...
        class C04401 implements Predicate<Entry<E>> {
            C04401() {
            }
        ...
        Set<Entry<E>> createEntrySet() {
            return Sets.filter(this.unfiltered.entrySet(), new C04401());
        }
