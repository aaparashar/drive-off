...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C04691 implements Function<Map<C, V>, Iterator<C>> {
        C04691() {
        }
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        final Iterator<C> merged = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C04691()), comparator);
