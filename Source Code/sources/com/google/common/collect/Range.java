...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
    ...
    private static final Function<Range, Cut> LOWER_BOUND_FN = new C04431();
    static final Ordering<Range<?>> RANGE_LEX_ORDERING = new C04453();
    private static final Function<Range, Cut> UPPER_BOUND_FN = new C04442();
    private static final long serialVersionUID = 0;
    final Cut<C> lowerBound;
    final Cut<C> upperBound;

    /* renamed from: com.google.common.collect.Range$1 */
    static class C04431 implements Function<Range, Cut> {
        C04431() {
        }
    ...
    static class C04442 implements Function<Range, Cut> {
        C04442() {
        }
    ...
    static class C04453 extends Ordering<Range<?>> {
        C04453() {
        }
