...
public final class Iterators {
    static final UnmodifiableListIterator<Object> EMPTY_LIST_ITERATOR = new C05791();
    private static final Iterator<Object> EMPTY_MODIFIABLE_ITERATOR = new C01892();

    /* renamed from: com.google.common.collect.Iterators$2 */
    static class C01892 implements Iterator<Object> {
        C01892() {
        }
    ...
    static class C05791 extends UnmodifiableListIterator<Object> {
        C05791() {
        }
    ...
    private static class MergingIterator<T> extends AbstractIterator<T> {
        ...
        final Queue<PeekingIterator<T>> queue = new PriorityQueue(2, new C01931());

        /* renamed from: com.google.common.collect.Iterators$MergingIterator$1 */
        class C01931 implements Comparator<PeekingIterator<T>> {
            C01931() {
            }
    ...
    public static String toString(Iterator<?> iterator) {
        return Joiner.on(", ").useForNull("null").appendTo(new StringBuilder().append('['), (Iterator) iterator).append(']').toString();
    }
    ...
    public static <T> T find(Iterator<? extends T> iterator, Predicate<? super T> predicate, @Nullable T defaultValue) {
        UnmodifiableIterator<? extends T> filteredIterator = filter((Iterator) iterator, (Predicate) predicate);
    ...
    public static int advance(Iterator<?> iterator, int numberToAdvance) {
        Preconditions.checkNotNull(iterator);
        Preconditions.checkArgument(numberToAdvance >= 0, "number to advance cannot be negative");
        int i = 0;
