...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final Queue<? extends Object> DISCARDING_QUEUE = new C02022();
    static final int DRAIN_MAX = 16;
    static final int DRAIN_THRESHOLD = 63;
    static final int MAXIMUM_CAPACITY = 1073741824;
    static final int MAX_SEGMENTS = 65536;
    static final ValueReference<Object, Object> UNSET = new C03981();
    ...
    static class C02022 extends AbstractQueue<Object> {
        C02022() {
        }
    ...
    static final class EvictionQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C05921();

        /* renamed from: com.google.common.collect.MapMakerInternalMap$EvictionQueue$1 */
        class C05921 extends AbstractReferenceEntry<K, V> {
    ...
    static final class ExpirationQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C05941();

        /* renamed from: com.google.common.collect.MapMakerInternalMap$ExpirationQueue$1 */
        class C05941 extends AbstractReferenceEntry<K, V> {
    ...
    static class C03981 implements ValueReference<Object, Object> {
        C03981() {
        }
