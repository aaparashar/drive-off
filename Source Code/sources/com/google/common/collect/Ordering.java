...
public abstract class Ordering<T> implements Comparator<T> {
    ...
    static class ArbitraryOrdering extends Ordering<Object> {
        private Map<Object, Integer> uids = Platform.tryWeakKeys(new MapMaker()).makeComputingMap(new C04421());

        /* renamed from: com.google.common.collect.Ordering$ArbitraryOrdering$1 */
        class C04421 implements Function<Object, Integer> {
    ...
    public <E extends T> List<E> leastOf(Iterator<E> elements, int k) {
        ...
        Preconditions.checkArgument(k >= 0, "k (%s) must be nonnegative", Integer.valueOf(k));
