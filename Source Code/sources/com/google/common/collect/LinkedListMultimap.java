...
public class LinkedListMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    class C01973 extends AbstractSequentialList<V> {
        C01973() {
        }
    ...
    class C01985 extends AbstractSequentialList<Entry<K, V>> {
        C01985() {
        }
    ...
    class C03842 extends ImprovedAbstractSet<K> {
        C03842() {
        }
    ...
    class C05836 extends AsMap<K, V> {
        C05836() {
        }
    ...
    private class MultisetView extends AbstractMultiset<K> {
        ...
        public int count(Object element) {
            KeyList<K, V> keyList = (KeyList) LinkedListMultimap.this.keyToKeyList.get(element);
            ...
            return new TransformedIterator<K, Multiset.Entry<K>>(new DistinctKeyIterator()) {
                Multiset.Entry<K> transform(final K key) {
                    return new AbstractEntry<K>() {
                        ...
                        public int getCount() {
                            return ((KeyList) LinkedListMultimap.this.keyToKeyList.get(key)).count;
                        }
                    };
                }
            };
        ...
        public int remove(@Nullable Object key, int occurrences) {
            ...
            int occurrences2 = occurrences;
            while (true) {
                occurrences = occurrences2 - 1;
                if (occurrences2 <= 0 || !values.hasNext()) {
                    return oldCount;
                }
                values.next();
                values.remove();
