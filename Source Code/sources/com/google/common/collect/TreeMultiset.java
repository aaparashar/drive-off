...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    class C02182 implements Iterator<Entry<E>> {
    ...
    class C02193 implements Iterator<Entry<E>> {
    ...
    public int add(@Nullable E element, int occurrences) {
        Preconditions.checkArgument(occurrences >= 0, "occurrences must be >= 0 but was %s", Integer.valueOf(occurrences));
        if (occurrences == 0) {
