...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    abstract class Itr<T> implements Iterator<T> {
        ...
        public void remove() {
            checkForConcurrentModification();
            Preconditions.checkState(this.toRemove != null, "Only one remove() call allowed per call to next");
    ...
    private final class Inverse extends AbstractMap<V, K> implements BiMap<V, K>, Serializable {
        ...
        class C05711 extends EntrySet<V, K> {

            /* renamed from: com.google.common.collect.HashBiMap$Inverse$1$1 */
            class C03611 extends Itr<Entry<V, K>> {
                ...
                class InverseEntry extends AbstractMapEntry<V, K> {
                    ...
                    public K setValue(K key) {
                        ...
                        C03611.this.expectedModCount = HashBiMap.this.modCount;
                        return oldKey;
                    }
                }
    ...
    private final class EntrySet extends EntrySet<K, V> {
        ...
        class C03601 extends Itr<Entry<K, V>> {
            ...
            class MapEntry extends AbstractMapEntry<K, V> {
                ...
                public V setValue(V value) {
                    ...
                    C03601.this.expectedModCount = HashBiMap.this.modCount;
                    if (C03601.this.toRemove == this.delegate) {
                        C03601.this.toRemove = newEntry;
                    }
    ...
    private void init(int expectedSize) {
        ...
        Preconditions.checkArgument(z, "expectedSize must be >= 0 but was %s", Integer.valueOf(expectedSize));
