...
public final class IntMath {
    ...
    @VisibleForTesting
    static int[] biggestBinomials = new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_STOP, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    public static int log2(int x, RoundingMode mode) {
        ...
        switch (C02421.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
