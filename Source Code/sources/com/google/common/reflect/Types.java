...
final class Types {
    ...
    private static final Function<Type, String> TYPE_TO_STRING = new C05111();
    ...
    private enum ClassOwnership {
        ...
        static class C05143 extends AnonymousClass1LocalClass<String> {
            C05143() {
            }
        }
        ...
        private static ClassOwnership detectJvmBehavior() {
            ParameterizedType parameterizedType = (ParameterizedType) new C05143().getClass().getGenericSuperclass();
    ...
    enum JavaVersion {
        ...
        static class C05151 extends TypeCapture<int[]> {
            C05151() {
            }
        }
    ...
    static class C05111 implements Function<Type, String> {
        C05111() {
        }
    ...
    static boolean containsTypeVariable(@Nullable Type type) {
        ...
        if (containsTypeVariable(wildcard.getUpperBounds()) || containsTypeVariable(wildcard.getLowerBounds())) {
            return true;
        }
        return false;
    }
