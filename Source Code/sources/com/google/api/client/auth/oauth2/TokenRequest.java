...
public class TokenRequest extends GenericData {
    ...
    class C03001 implements HttpRequestInitializer {
        C03001() {
        }
    ...
    public final HttpResponse executeUnparsed() throws IOException {
        HttpRequest request = this.transport.createRequestFactory(new C03001()).buildPostRequest(this.tokenServerUrl, new UrlEncodedContent(this));
