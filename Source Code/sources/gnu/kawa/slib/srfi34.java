...
public class srfi34 extends ModuleBody {
    ...
    static {
        ...
        objArr = new Object[]{Lit9, Lit8, Lit10, PairWithPosition.make(Lit8, LList.Empty, "srfi34.scm", 274452)};
        r11[1] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007<\f\u000f\f\u0002\f\u0017\b\b", new Object[]{Lit7}, 3), "\u0001\u0001\u0001", "\u0011\u0018\u00041\b\u0011\u0018\f\b\u000b\b\u0011\u0018\u0014\u0011\u0018\f!\t\u0013\u0018\u001c\b\u0003", objArr, 0);
        objArr = new Object[]{Lit9, Lit8, Lit10, PairWithPosition.make(Lit8, LList.Empty, "srfi34.scm", 294932), Lit4};
        ...
        PairWithPosition make = PairWithPosition.make((SimpleSymbol) new SimpleSymbol(GetNamedPart.INSTANCEOF_METHOD_NAME).readResolve(), PairWithPosition.make(Lit12, PairWithPosition.make(Lit13, LList.Empty, "srfi34.scm", 110614), "srfi34.scm", 110611), "srfi34.scm", 110600);
        ...
        objArr[6] = Lit4;
        objArr[7] = PairWithPosition.make((SimpleSymbol) new SimpleSymbol("primitive-throw").readResolve(), PairWithPosition.make(Lit12, LList.Empty, "srfi34.scm", 122914), "srfi34.scm", 122897);
