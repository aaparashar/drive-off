...
public class srfi1 extends ModuleBody {
    ...
    static {
        ...
        Lit14 = simpleSymbol2;
        r4[7] = PairWithPosition.make(simpleSymbol2, PairWithPosition.make(Lit100, LList.Empty, "srfi1.scm", 5722136), "srfi1.scm", 5722124);
        r4[8] = PairWithPosition.make(Lit101, LList.Empty, "srfi1.scm", 5722148);
        ...
        switch (moduleMethod.selector) {
            ...
            case 122:
                ...
                try {
                    ...
                    throw new WrongType(e, "count", 1, obj3);
                }
            case 123:
                ...
                try {
                    ...
                    try {
                        ...
                        throw new WrongType(e22, "unfold-right", 2, obj);
                    }
                } catch (ClassCastException e3) {
                    throw new WrongType(e3, "unfold-right", 1, obj3);
                }
            case 125:
                obj3 = objArr[0];
                try {
                    ...
                    try {
                        ...
                        throw new WrongType(e2222, "unfold", 2, obj);
                    }
                } catch (ClassCastException e32) {
                    throw new WrongType(e32, "unfold", 1, obj3);
                }
            case 126:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322, "fold", 1, obj3);
                }
            case 127:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222, "fold-right", 1, obj3);
                }
            case DateTime.TIMEZONE_MASK /*128*/:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222, "pair-fold-right", 1, obj3);
                }
            case 129:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222, "pair-fold", 1, obj3);
                }
            case 132:
                obj2 = objArr[0];
                obj4 = objArr[1];
                ...
                while (true) {
                    length--;
                    if (length < 0) {
                        return appendMap$V(obj2, obj4, objArr2);
                    }
            ...
            case 133:
                ...
                while (true) {
                    length--;
                    if (length < 0) {
                        return appendMap$Ex$V(obj2, obj4, objArr2);
                    }
                    objArr2[length] = objArr[length + 2];
                }
            case 134:
                ...
                try {
                    ...
                    throw new WrongType(e3222222, "pair-for-each", 1, obj3);
                }
            case 135:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222, "map!", 1, obj3);
                }
            case 136:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222, "filter-map", 1, obj3);
                }
            case 166:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222, "any", 1, obj3);
                }
            case 167:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222222, "every", 1, obj3);
                }
            case 168:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222222, "list-index", 1, obj3);
                }
            case 169:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222222, "lset<=", 1, obj3);
                }
            case 170:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222222222, "lset=", 1, obj3);
                }
            case 171:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222222222, "lset-adjoin", 1, obj3);
                }
            case 172:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222222222, "lset-union", 1, obj3);
                }
            case 173:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222222222222, "lset-union!", 1, obj3);
                }
            case 174:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222222222222, "lset-intersection", 1, obj3);
                }
            case 175:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222222222222, "lset-intersection!", 1, obj3);
                }
            case ComponentConstants.VIDEOPLAYER_PREFERRED_WIDTH /*176*/:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222222222222222, "lset-difference", 1, obj3);
                }
            case 177:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222222222222222, "lset-difference!", 1, obj3);
                }
            case 178:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222222222222222, "lset-xor", 1, obj3);
                }
            case 179:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e32222222222222222222222, "lset-xor!", 1, obj3);
                }
            case 180:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e322222222222222222222222, "lset-diff+intersection", 1, obj3);
                }
            case 181:
                obj3 = objArr[0];
                try {
                    ...
                    throw new WrongType(e3222222222222222222222222, "lset-diff+intersection!", 1, obj3);
                }
            default:
