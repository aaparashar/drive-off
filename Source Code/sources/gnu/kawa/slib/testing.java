...
public class testing extends ModuleBody {
    ...
    static final PairWithPosition Lit8 = PairWithPosition.make(Lit14, PairWithPosition.make(Lit9, LList.Empty, "testing.scm", 1966107), "testing.scm", 1966101);
    ...
    static {
        ...
        Lit60 = simpleSymbol3;
        r6[1] = PairWithPosition.make(PairWithPosition.make(simpleSymbol2, PairWithPosition.make(PairWithPosition.make(simpleSymbol3, LList.Empty, "testing.scm", 3952660), LList.Empty, "testing.scm", 3952660), "testing.scm", 3952652), LList.Empty, "testing.scm", 3952651);
        ...
        simpleSymbol3 = (SimpleSymbol) new SimpleSymbol("%test-runner-fail-list").readResolve();
        Lit33 = simpleSymbol3;
        r6[7] = PairWithPosition.make(PairWithPosition.make(simpleSymbol3, PairWithPosition.make(Lit143, LList.Empty, "testing.scm", 3964958), "testing.scm", 3964934), LList.Empty, "testing.scm", 3964934);
        ...
        simpleSymbol3 = (SimpleSymbol) new SimpleSymbol("%test-runner-skip-list").readResolve();
        Lit31 = simpleSymbol3;
        r6[7] = PairWithPosition.make(PairWithPosition.make(simpleSymbol3, PairWithPosition.make(Lit143, LList.Empty, "testing.scm", 3932190), "testing.scm", 3932166), LList.Empty, "testing.scm", 3932166);
        syntaxRuleArr[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\r\u0007\u0000\b\b", new Object[0], 1), "\u0003", "\u0011\u0018\u0004\u0011\u0018\f\b\u0011\u0018\u0014\u0011\u0018\u001c\b\u0011\u0018$Q\u0011\u0018,\b\u0005\u0011\u00184\b\u0003\u0018<", r6, 1);
        ...
        Lit13 = make;
        r6[1] = PairWithPosition.make(make, LList.Empty, "testing.scm", 3727384);
        ...
        objArr2[0] = Lit150;
        objArr2[1] = PairWithPosition.make(Lit149, PairWithPosition.make(PairWithPosition.make(Lit60, LList.Empty, "testing.scm", 3469326), LList.Empty, "testing.scm", 3469326), "testing.scm", 3469323);
        objArr2[2] = Lit160;
        objArr2[3] = Lit52;
        objArr2[4] = Lit149;
        objArr2[5] = Lit145;
        ...
        Lit7 = simpleSymbol4;
        objArr2[6] = PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol4, LList.Empty, "testing.scm", 3477545), "testing.scm", 3477545);
        objArr2[7] = Lit115;
        ...
        Lit78 = simpleSymbol3;
        r6[2] = simpleSymbol3;
        r6[3] = PairWithPosition.make(PairWithPosition.make(Lit15, PairWithPosition.make(Lit152, LList.Empty, "testing.scm", 3223581), "testing.scm", 3223581), PairWithPosition.make(Boolean.TRUE, LList.Empty, "testing.scm", 3223596), "testing.scm", 3223580);
        simpleSymbol3 = (SimpleSymbol) new SimpleSymbol("%test-on-test-end").readResolve();
        Lit87 = simpleSymbol3;
        r6[4] = simpleSymbol3;
        r6[5] = Lit154;
        r6[6] = Lit144;
        r6[7] = PairWithPosition.make(Lit15, PairWithPosition.make(Lit155, LList.Empty, "testing.scm", 3239966), "testing.scm", 3239966);
        r6[8] = PairWithPosition.make(Boolean.FALSE, LList.Empty, "testing.scm", 3244041);
        r6[9] = Lit151;
        r6[10] = Lit156;
        r6[11] = PairWithPosition.make(PairWithPosition.make(Lit15, PairWithPosition.make(Lit157, LList.Empty, "testing.scm", 3252256), "testing.scm", 3252256), PairWithPosition.make(Lit151, LList.Empty, "testing.scm", 3252269), "testing.scm", 3252255);
        r6[12] = PairWithPosition.make(Boolean.TRUE, LList.Empty, "testing.scm", 3256331);
        simpleSymbol3 = (SimpleSymbol) new SimpleSymbol("%test-report-result").readResolve();
        Lit83 = simpleSymbol3;
        r6[13] = PairWithPosition.make(PairWithPosition.make(simpleSymbol3, LList.Empty, "testing.scm", 3260424), LList.Empty, "testing.scm", 3260424);
        ...
        r6[3] = Lit153;
        r6[4] = Lit78;
        r6[5] = PairWithPosition.make(PairWithPosition.make(Lit15, PairWithPosition.make(Lit152, LList.Empty, "testing.scm", 3276828), "testing.scm", 3276828), PairWithPosition.make(Lit153, LList.Empty, "testing.scm", 3276843), "testing.scm", 3276827);
        r6[6] = Lit87;
        r6[7] = Lit154;
        r6[8] = PairWithPosition.make(Lit15, PairWithPosition.make(Lit155, LList.Empty, "testing.scm", 3293213), "testing.scm", 3293213);
        r6[9] = PairWithPosition.make(Boolean.FALSE, LList.Empty, "testing.scm", 3297288);
        r6[10] = Lit151;
        r6[11] = Lit156;
        r6[12] = PairWithPosition.make(PairWithPosition.make(Lit15, PairWithPosition.make(Lit157, LList.Empty, "testing.scm", 3305503), "testing.scm", 3305503), PairWithPosition.make(Lit151, LList.Empty, "testing.scm", 3305516), "testing.scm", 3305502);
        ...
        r6[14] = PairWithPosition.make(PairWithPosition.make(Lit83, LList.Empty, "testing.scm", 3325959), LList.Empty, "testing.scm", 3325959);
        ...
        r6 = new Object[6];
        r6[0] = Lit150;
        r6[1] = PairWithPosition.make(PairWithPosition.make(Lit149, PairWithPosition.make(PairWithPosition.make(Lit60, LList.Empty, "testing.scm", 2916364), LList.Empty, "testing.scm", 2916364), "testing.scm", 2916361), LList.Empty, "testing.scm", 2916360);
        r6[2] = Lit52;
        r6[3] = Lit149;
        ...
        r6 = new Object[5];
        r6[0] = Lit150;
        r6[1] = PairWithPosition.make(PairWithPosition.make(Lit149, PairWithPosition.make(PairWithPosition.make(Lit60, LList.Empty, "testing.scm", 2781198), LList.Empty, "testing.scm", 2781198), "testing.scm", 2781195), LList.Empty, "testing.scm", 2781194);
        r6[2] = Lit52;
        r6[3] = Lit149;
        ...
        r6[4] = simpleSymbol3;
        r6[5] = Lit78;
        r6[6] = PairWithPosition.make(PairWithPosition.make(Lit15, PairWithPosition.make(Lit155, LList.Empty, "testing.scm", 2666526), "testing.scm", 2666526), PairWithPosition.make(Lit162, LList.Empty, "testing.scm", 2666539), "testing.scm", 2666525);
        r6[7] = Lit87;
        r6[8] = PairWithPosition.make(Lit162, LList.Empty, "testing.scm", 2670622);
        r6[9] = PairWithPosition.make(PairWithPosition.make(Lit83, LList.Empty, "testing.scm", 2674696), LList.Empty, "testing.scm", 2674696);
        ...
        objArr[0] = simpleSymbol;
        syntaxRuleArr = new SyntaxRule[2];
        syntaxRuleArr[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\b", new Object[0], 2), "\u0001\u0001", "\u0011\u0018\u0004\t\u0003\t\u000b\u0018\f", new Object[]{Lit75, PairWithPosition.make(Boolean.FALSE, LList.Empty, "testing.scm", 1933348)}, 0);
        r6 = new Object[6];
        simpleSymbol3 = (SimpleSymbol) new SimpleSymbol("test-result-alist").readResolve();
        Lit51 = simpleSymbol3;
        r6[3] = simpleSymbol3;
        r6[4] = Lit161;
        r6[5] = PairWithPosition.make((SimpleSymbol) new SimpleSymbol("cdr").readResolve(), PairWithPosition.make(Lit164, LList.Empty, "testing.scm", 1945619), "testing.scm", 1945614);
        ...
        r6[0] = simpleSymbol3;
        r6[1] = Lit165;
        r6[2] = PairWithPosition.make(Lit147, PairWithPosition.make(LList.Empty, PairWithPosition.make(Boolean.FALSE, LList.Empty, "testing.scm", 1826831), "testing.scm", 1826828), "testing.scm", 1826820);
        r6[3] = Lit147;
        ...
        Lit62 = simpleSymbol3;
        r6[8] = PairWithPosition.make(simpleSymbol3, PairWithPosition.make(Lit149, LList.Empty, "testing.scm", 1781794), "testing.scm", 1781772);
        r6[9] = Lit165;
        r6[10] = Lit147;
        ...
        Lit9 = simpleSymbol;
        Lit11 = PairWithPosition.make(simpleSymbol4, PairWithPosition.make(simpleSymbol, LList.Empty, "testing.scm", 2220088), "testing.scm", 2220082);
        ...
        Lit6 = simpleSymbol8;
        Lit10 = PairWithPosition.make(simpleSymbol7, PairWithPosition.make(simpleSymbol, PairWithPosition.make(simpleSymbol4, PairWithPosition.make(simpleSymbol8, LList.Empty, "testing.scm", 2072618), "testing.scm", 2072606), "testing.scm", 2072594), "testing.scm", 2072583);
        ...
        moduleMethod.setProperty("source-location", "testing.scm:187");
        lambda$Fn2 = moduleMethod;
        moduleMethod = new ModuleMethod(moduleBody, 52, null, 12291);
        moduleMethod.setProperty("source-location", "testing.scm:188");
