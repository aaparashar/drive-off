...
public class conditions extends ModuleBody {
    ...
    static final PairWithPosition Lit2 = PairWithPosition.make(Lit5, LList.Empty, "conditions.scm", 925699);
    ...
    static {
        ...
        r4[2] = simpleSymbol2;
        r4[3] = Lit21;
        r4[4] = PairWithPosition.make(Lit22, LList.Empty, "conditions.scm", 327708);
        r4[5] = (SimpleSymbol) new SimpleSymbol("and").readResolve();
        r4[6] = PairWithPosition.make(Lit10, PairWithPosition.make(Lit22, LList.Empty, "conditions.scm", 331803), "conditions.scm", 331791);
        r4[7] = Lit12;
        r4[8] = Lit22;
        r4[9] = PairWithPosition.make(Lit18, LList.Empty, "conditions.scm", 339996);
        r4[10] = Lit15;
        r4[11] = Lit17;
        r4[12] = Lit18;
