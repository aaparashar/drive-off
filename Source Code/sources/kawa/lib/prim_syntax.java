...
public class prim_syntax extends ModuleBody {
    ...
    static {
        ...
        syntaxRuleArr[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\b", new Object[0], 1), "\u0001", "\u0011\u0018\u0004\b\u0003", new Object[]{PairWithPosition.make(Lit46, Pair.make(Lit47, Pair.make(Pair.make(Lit48, Pair.make((SimpleSymbol) new SimpleSymbol("rewriteBody").readResolve(), LList.Empty)), LList.Empty)), "prim_syntax.scm", 270343)}, 0);
        ...
        syntaxRuleArr[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\b", new Object[0], 1), "\u0001", "\u0011\u0018\u0004\b\u0003", new Object[]{PairWithPosition.make(Lit46, Pair.make(Lit47, Pair.make(Pair.make(Lit48, Pair.make((SimpleSymbol) new SimpleSymbol("rewrite").readResolve(), LList.Empty)), LList.Empty)), "prim_syntax.scm", 249863)}, 0);
        ...
        moduleMethod.setProperty("source-location", "prim_syntax.scm:89");
        try$Mncatch = Macro.make(simpleSymbol, moduleMethod, $instance);
        simpleSymbol = Lit29;
        moduleMethod = new ModuleMethod(moduleBody, 4, null, 4097);
        moduleMethod.setProperty("source-location", "prim_syntax.scm:98");
