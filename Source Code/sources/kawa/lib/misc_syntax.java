...
public class misc_syntax extends ModuleBody {
    ...
    static {
        ...
        Lit8 = simpleSymbol3;
        r4[2] = PairWithPosition.make(simpleSymbol2, Pair.make(PairWithPosition.make(simpleSymbol3, LList.Empty, "misc_syntax.scm", 159755), Pair.make(Pair.make(Lit24, Pair.make((SimpleSymbol) new SimpleSymbol("resolve").readResolve(), LList.Empty)), LList.Empty)), "misc_syntax.scm", 159755);
        ...
        moduleMethod.setProperty("source-location", "misc_syntax.scm:54");
