...
public class syntax extends ModuleBody {
    ...
    static final SyntaxTemplate Lit68 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit102, Pair.make(Lit118, Pair.make(Pair.make(Lit104, Pair.make(Lit119, LList.Empty)), LList.Empty)), "syntax.scm", 458759)}, 0);
    ...
    static final SyntaxTemplate Lit73 = new SyntaxTemplate("\u0001\u0001\u0001", "\u0018\u0004", new Object[]{PairWithPosition.make(Lit102, Pair.make(Lit118, Pair.make(Pair.make(Lit104, Pair.make(Lit119, LList.Empty)), LList.Empty)), "syntax.scm", 466951)}, 0);
    ...
    static {
        ...
        r7 = new Object[21];
        r7[4] = PairWithPosition.make(Lit102, Pair.make(Lit103, Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol) new SimpleSymbol("makeNamed").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1069060);
        r7[5] = Lit108;
        r7[6] = PairWithPosition.make(Lit102, Pair.make(Lit103, Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol) new SimpleSymbol("pushConverter").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1073161);
        r7[7] = Lit109;
        r7[8] = PairWithPosition.make(Lit105, LList.Empty, "syntax.scm", 1081354);
        r7[9] = (SimpleSymbol) new SimpleSymbol("try-catch").readResolve();
        r7[10] = Lit106;
        r7[11] = PairWithPosition.make(Lit105, LList.Empty, "syntax.scm", 1089550);
        ...
        r7[14] = Lit115;
        r7[15] = Lit107;
        r7[16] = PairWithPosition.make(Lit102, Pair.make((SimpleSymbol) new SimpleSymbol("gnu.mapping.WrongType").readResolve(), Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol) new SimpleSymbol("make").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1097748);
        ...
        r7[19] = PairWithPosition.make((SimpleSymbol) new SimpleSymbol("field").readResolve(), PairWithPosition.make(Lit107, PairWithPosition.make(PairWithPosition.make(Lit108, PairWithPosition.make((SimpleSymbol) new SimpleSymbol("expectedType").readResolve(), LList.Empty, "syntax.scm", 1105941), "syntax.scm", 1105941), LList.Empty, "syntax.scm", 1105940), "syntax.scm", 1105937), "syntax.scm", 1105930);
        r7[20] = PairWithPosition.make(PairWithPosition.make((SimpleSymbol) new SimpleSymbol("primitive-throw").readResolve(), PairWithPosition.make(Lit107, LList.Empty, "syntax.scm", 1110037), "syntax.scm", 1110020), LList.Empty, "syntax.scm", 1110020);
        ...
        syntaxRuleArr2[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\b", new Object[0], 0), "", "\u0018\u0004", new Object[]{PairWithPosition.make((SimpleSymbol) new SimpleSymbol("%syntax-error").readResolve(), PairWithPosition.make("Unfulfilled cond-expand", LList.Empty, "syntax.scm", 802851), "syntax.scm", 802836)}, 0);
        ...
        r7 = new Object[]{Lit77, "mktmp", PairWithPosition.make(Lit117, LList.Empty, "syntax.scm", 569387), PairWithPosition.make(Lit117, LList.Empty, "syntax.scm", 569414)};
        syntaxRuleArr2[4] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0002\u001c\f\u0007\u000b\f\u0017,\r\u001f\u0018\b\b\f',\r/(\b\b\f7\b", new Object[]{"mktmp"}, 7), "\u0001\u0000\u0001\u0003\u0001\u0003\u0001", "\u0011\u0018\u0004\u0011\u0018\f\t\n\t\u0013)\u0011\u001d\u001b\u0018\u0014\t#A\u0011-+\b\t\u0003\u0018\u001c\b3", r7, 1);
        r7 = new Object[]{Lit116, Lit109, Lit117, Lit77, "bind", PairWithPosition.make(Lit117, LList.Empty, "syntax.scm", 593973)};
        ...
        syntaxRuleArr2[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\r\u0007\u0000\b\b", new Object[0], 1), "\u0003", "\u0011\u0018\u0004\b\u0005\u0011\u0018\f\t\u0003\u0018\u0014", new Object[]{Lit110, Lit38, PairWithPosition.make(LList.Empty, LList.Empty, "syntax.scm", 376866)}, 1);
        ...
        objArr2[0] = simpleSymbol;
        syntaxRuleArr2 = new SyntaxRule[1];
        syntaxRuleArr2[0] = new SyntaxRule(new SyntaxPattern("\f\u0018\f\u0007\f\u000f\u0013", new Object[0], 3), "\u0001\u0001\u0000", "\u0011\u0018\u0004\t\u0003\b\u0011\u0018\f\u0011\u0018\u0014\b\u0011\u0018\u001c\u0011\u0018$\t\u000b\u0012", new Object[]{(SimpleSymbol) new SimpleSymbol("define-syntax").readResolve(), Lit109, PairWithPosition.make(Lit122, LList.Empty, "syntax.scm", 90129), (SimpleSymbol) new SimpleSymbol("syntax-case").readResolve(), Lit122}, 0);
        ...
        f109synchronized = Macro.make(Lit25, new ModuleMethod(moduleBody, 3, null, 4097), $instance);
